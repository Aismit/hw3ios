            ...
            Auth.auth().createUser(withEmail: email, password: password) { (user, error) in
                if error == nil {
                    ...
                    changeRequest?.commitChanges { (error) in
                        if error == nil {
                            let alert = UIAlertController(title: "Display Name Created", message: "Cool!", preferredStyle: .alert)
                    ...
                    Auth.auth().createUser(withEmail: email, password: password) { (result, error) in
                        ...
                        let alert = UIAlertController(title: "Sign Up", message: "Sign Up Worked!", preferredStyle: .alert)
